...
description: "DAWG 0.2.3-naughty pairs a Tauri desktop app with a Chromium extension to capture, sanitize, catalog, import, export, and replay portable OCI-based .dawg artifacts."
head:
