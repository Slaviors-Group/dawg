...
This reference describes the DAWG `0.3.2-middlechild` command-line interface.
...
- the current `0.3.2-middlechild` manifest schema
...
```yaml
schemaVersion: "0.3.2-middlechild"
capture:
